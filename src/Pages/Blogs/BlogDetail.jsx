                ...
                <section className="bg-white dark:bg-gray-800 py-5 my-5 lg:py-16 max-w-screen-lg shadow-xl rounded-xl">
                    <div className="max-w-2xl mx-auto px-4">
                        ...
                        {createdBy !== user.email ? (
                            ...
                            <p>You Don&apos;t have persmisson to Comment.</p>
                        )}
                    </div>
                </section>
                        ...
                        comments.data.map((comment) => (
                            <article
                                ...
                                <footer className="flex justify-between items-center mb-2">
                                    ...
                                    <Link className='bg-blue-500 rounded text-white px-1 py-0.5' to={`/update-comment/${comment._id}`}>Edit</Link>
                                </footer>
